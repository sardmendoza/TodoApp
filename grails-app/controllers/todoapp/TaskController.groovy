...
//                redirect task
    ...
    def update(Task task) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.updated.message', args: [message(default: 'Task'), task.id])
                redirect task
            }
    ...
    def delete(Long id) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.deleted.message', args: [message(default: 'Task'), id])
    ...
    protected void notFound() {
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.not.found.message', args: [message(default: 'Task'), params.id])
                redirect action: "index", method: "GET"
            }
